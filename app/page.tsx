...
export default function HomePage() {
  ...
  const openDetail = (expense: Expense) => { if (expense.syncStatus) { notify('This receipt will be available after it syncs'); return; } setDetail(expense); setFlagReason(''); setDraft({ ...blankDraft(), merchant: expense.merchant, amount: String(expense.amount), category: expense.category, receiptDate: expense.receiptDate, payerId: expense.payerId, image: expense.image ?? '', imagePath: expense.imagePath ?? '', notes: expense.notes ?? '', ocrStatus: expense.ocrStatus }); setSheetExpanded(false); setSheetOpen(true); };
